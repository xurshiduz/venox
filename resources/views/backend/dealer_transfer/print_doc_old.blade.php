				...
				<table width="100%">
					<tbody>
						<tr style="text-align: center;">
							...
							<td style="padding: 0px 5px;" rowspan="2">Стоим. поставки с учетом НДС</td>
						</tr>
						<tr style="text-align: center;">
						...
						<tr>
							...
							<td style="padding: 0px 5px;">{{ $detail->prodid->fullname }}</td>
							...
							<td style="padding: 0px 5px;">@if($view == 'short') 1.00 @else {{ $detail->price }} @endif</td>
							<td style="padding: 0px 5px;">@if($view == 'short') {{ $detail->qty }}.00 @else {{ $detail->total_price }} @endif</td>
							<td style="padding: 0px; text-align: center;" width="130" colspan="2">Без акцизного налога</td>
							<td style="padding: 0px 5px; text-align: center;" colspan="2">Без НДС</td>
							<td style="padding: 0px 5px;"></td>
						</tr>
						@endforeach
						<tr>
							...
							<td style="padding: 0px 5px;"> </td>
							<td style="padding: 0px 5px;"> </td>
							<td style="padding: 0px 5px;">@if($view == 'short') {{ number_format($item->details()->sum('qty'), 2, '.', ' ') }} @else {{ number_format($item->details()->sum('total_price'), 2, '.', ' ') }} @endif</td>
							<td style="padding: 0px 5px; text-align: end;" colspan="2"></td>
