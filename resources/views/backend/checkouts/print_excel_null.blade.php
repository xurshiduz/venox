...
<table width="100%">
	<tbody>
		...
		<tr>
			...
			<td style="padding: 0px 5px; text-align: center; border: 1px solid #000000;">1.00</td>
			<td style="padding: 0px 5px; text-align: center; border: 1px solid #000000;">{{ $detail->qty }}.00</td>
		...
		<tr>
			...
			<td style="text-align: center; border: 1px solid #000000;"> </td>
			<td style="text-align: center; border: 1px solid #000000;"> </td>
			<td style="padding: 0px 5px; text-align: center;  border: 1px solid #000000;"><b>{{ number_format($item->details()->sum('qty'), 2, '.', ' ') }}</b></td>
			<td style="text-align: center; border: 1px solid #000000;"></td>
		</tr>
        <tr>
            <td></td>
            <td colspan="7" style="border: 0px; padding: 5px 0px;">Всего отпущено на сумму: 
