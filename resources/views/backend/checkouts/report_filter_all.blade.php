                        ...
                        <div class="card card-bordered">
                            ...
                            <div class="card-inner">
                                <div class="preview-block">
                                    <form method="POST" action="{{ route('checkouts_report_print_filter') }}">
                                        @csrf
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" name="fromdate" value="01.01.{{ Carbon\Carbon::now()->format('Y') }}" class="form-control date-picker" placeholder="дата">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" name="todate" value="{{ Carbon\Carbon::now()->endOfYear()->format('d.m.Y')}}" class="form-control date-picker" placeholder="дата">
                                                </div>
                                            </div>
                                        </div>
