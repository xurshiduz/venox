...
<html>
	...
	<body class="document" style="font-size: 11px">
	    <?php \Carbon\Carbon::setLocale('ru') ?> 
		<div class="page" contenteditable="true">
			<h3 style="margin: 0px" class="title-order">СЧЕТ-ФАКТУРА-НАКЛАДНАЯ №{{ $item->number_work }} от {{ Carbon\Carbon::parse($item->date)->format('d.m.y') }}г.</h3>
			<p style="font-weight: bold; margin: 0 0 5px 0; text-align: center;">к товарно-отгрузочные документам:</p>
		...
		<div class="wordpdf">
				...
				<table width="100%">
					<tbody>
						<tr style="text-align: center;">
							...
							<td style="padding: 0px 5px;">Бонус</td>
							<td style="padding: 0px 5px;">Цена</td>
							<td style="padding: 0px 5px;">Стоимость поставки</td>
							<!--<td style="padding: 0px 5px;">Стоим. поставки с учетом НДС</td>-->
						</tr>
						...
						<tr>
							...
							<td style="padding: 0px 5px; text-align: center;">{{ $detail->qty }}</td>
							<td style="padding: 0px 5px; text-align: center;">{{ $detail->bonus }}</td>
							<td style="padding: 0px 5px; text-align: center;">@if($view == 'short') 1.00 @else {{ number_format($detail->price, 2, '.', ' ') }} @endif</td>
							<td style="padding: 0px 5px; text-align: center;">@if($view == 'short') {{ $detail->qty }}.00 @else {{ number_format($detail->total_price, 2, '.', ' ') }} @endif</td>
							<!--<td style="padding: 0px 5px;"></td>-->
						</tr>
						@endforeach
						<tr>
							...
							<td style="padding: 0px 5px;"> </td>
							<td style="padding: 0px 5px;"> </td>
							<td style="padding: 0px 5px; text-align: center;">@if($view == 'short') {{ number_format($item->details()->sum('qty'), 2, '.', ' ') }} @else {{ number_format($item->details()->sum('total_price'), 2, '.', ' ') }} @endif</td>
							<!--<td style="padding: 0px 5px;"></td>-->
						</tr>
					</tbody>
				</table>
            ...
            <table style="border: 0px; width: 100%;">
                <tbody>
                    ...
                    <tr>
                        <td style="border: 0px; padding: 5px 0px;" width="50%">Менеджер Ф.И.О: {{ $item->managerid ? $item->managerid->name : NULL }}</td>
                        <td style="border: 0px; padding: 5px 0px;" width="50%">Менеджер Тел: {{ $item->managerid ? $item->managerid->phone : NULL }}</td>
                    </tr>
                </tbody>
            </table>
			</div>
