...
<table width="100%">
	<tbody>
		<tr style="text-align: center;">
			...
			<td width="60px" style="border: 1px solid #000000; vertical-align: middle;">Бонус</td>
		...
		<tr>
			...
			<td style="padding: 0px 5px; text-align: center; border: 1px solid #000000;">{{ $detail->bonus }}</td>
