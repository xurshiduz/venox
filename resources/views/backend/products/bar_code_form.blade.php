                                ...
                                <div class="col-md-9">
                                    <ul class="data-list is-compact">
                                        ...
                                        @foreach($dealers as $dealer)
                                            ...
                                            @php($st = $item->stockid()->where('warehouse_id', $ware->id)->sum('stock'))
                                            <li class="data-item">
                                                <div class="data-col">
                                                    <div class="data-label">* {{ trans('backend.table.stock') }} {{ $ware->name }}</div>
                                                    <div class="data-value" style="width: 10%">
                                                        {{ $st }} {{ $item->unitid ? $item->unitid->name : null}}
                                                    ...
                                                    @hasanyrole('admin222|arrival222')
                                                    <div class="data-value">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modalDefault{{ $ware->id }}">Поправка</a> 
                                                        
                                                        <div class="modal fade" tabindex="-1" id="modalDefault{{ $ware->id }}">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <form action="{{ route('stock_adjustment_save') }}" method="POST" id="appointment_form">
                                                                        @csrf
                                                                        <input type="hidden" name="warehouse_id" value="{{ $ware->code }}">
                                                                        <input type="hidden" name="product_id" value="{{ $item->code }}">
                                                                        <input type="hidden" name="old_stock" value="{{ $st }}">
                                                                        <div class="row gy-1">
                                                                            <div class="col-lg-3 col-sm-3">
                                                                                <div class="form-group">
                                                                                    <label class="form-label" for="ost">Остаток на {{ $ware->num_code }}</label>
                                                                                    <div class="form-control-wrap">
                                                                                        <input type="text" class="form-control" readonly value="{{ $st }}" id="ost" placeholder="Остаток">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-lg-4 col-sm-4">
                                                                                <div class="form-group">
                                                                                    <label class="form-label" for="summa">Внесите факт. остаток</label>
                                                                                    <div class="form-control-wrap">
                                                                                        <input type="text" class="form-control" name="stock" id="formattedNumberField" placeholder="Внесите факт. остаток">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <li class="data-item">
                                            <div class="data-col">
                                                ...
                                                <div class="data-value">
                                                    {{ $item->stockid()->sum('stock') }} {{ $item->unitid ? $item->unitid->name : null}}
