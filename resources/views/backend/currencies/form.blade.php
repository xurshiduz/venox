                                    ...
                                    <div class="row gy-3">
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label" for="default-01">Курс </label>
                                                <div class="form-control-wrap">
                                                    <input type="number" class="form-control" id="default-01" name="price" placeholder="Курс" value="{{ $item ? $item->price : NULL }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
